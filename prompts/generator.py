...
def generate_combined(no_mask, add_pattern):
    """Generate both individual files and a combined all.md file (legacy behavior)"""
    # Define the project root as the current working directory
    project_root = os.getcwd()
    ...
    # Create the all-in-one file within the output directory
